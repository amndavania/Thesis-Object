...
class DpaController extends Controller
{
    ...
    public function store(DpaCreateRequest $request):RedirectResponse //ini
    {
     ...
     */
    public function update(DpaUpdateRequest $request, string $id):RedirectResponse //ini
    {
        $dpa = Dpa::findOrFail($id);
     ...
     */
    public function destroy($id) //ini
    {
        $dpa = Dpa::findOrFail($id);
    ...
    public function getMahasiswa(Request $request): View //ini
    {
    ...
    public function export(Request $request)
    {
        ...
        $dpa = Dpa::where('id', $dpa_id)->first();
        $students = Student::where('dpa_id', $dpa_id)->get(); //student class/model dari getBimbinganStudi() diambil dari sini
    ...
    public function setujuKrs($id, $status, $student_id, $tahunAjaran, $semester) //ini
    {
    ...
    public function getBimbinganStudi($students, $tahunAjaran, $semester) //ini
    {
        $data = [];
