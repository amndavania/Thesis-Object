...
class UktController extends Controller
{
    ...
    public function destroy(String $id):RedirectResponse //menghapus data pembayaran dan entitas terkait
    {
        ...
        $this->transactionServiceController->deleteTransaction($ukt->transaction_debit_id); //Transaction
        ...
        $this->transactionServiceController->updateTransactionAccount(1120, 'kredit', -$ukt->amount); //TransactionAccount
