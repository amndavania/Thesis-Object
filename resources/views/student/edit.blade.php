     ...
     <div class="card-body">
        @include('message.form-message')
          ...
          <div class="form-group">
               ...
               <input type="text" class="form-control" id="name" name="name" placeholder="Masukkan nama mahasiswa" value="{{ old('name', $student->name) }}">
          </div>
          <div class="form-group">
               <label for="nim">NIM</label>
               <input type="text" class="form-control" id="nim" name="nim" placeholder="Masukkan NIM" value="{{ old('nim', $student->nim) }}">
          </div>
          <div class="form-group">
               <label for="force">Tahun Masuk</label>
               <input type="number" class="form-control" id="force" name="force" placeholder="Masukkan tahun masuk" value="{{ old('force', $student->force) }}">
          </div>
          <div class="form-group">
          ...
          <select class="form-control" id="student_types_id" name="student_types_id">
            ...
            @foreach ($student_type as $item)
                <option value="{{ $item->id }}" data-year="{{ $item->year }}" {{ $student->student_types_id == $item->id ? 'selected' : '' }}>
