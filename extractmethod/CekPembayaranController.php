...
class CekPembayaranController extends Controller
{
    ...
    public function data(Request $request) 
    {
        ...
        $student_id = $this->resolveStudentIdIfEmpty($student_id); // ekstrak s21–s24
        $this->handleDispensasi($uktController, $student_id, $payment_id, $dispensasi); // ekstrak s8–s20
    
        return $this->handleStudentValidationAndResponse($request); // ekstrak s25–s37
    }
